---
title: "Flight Delays Analysis – Temporal Dynamics and Propagation Effects"
author: "Hela Bouhlel"
date: "2025-12-28"
format:
  html:
...
---
## Introduction
Beyond aggregate statistics, understanding flight delays requires analyzing their
temporal evolution and interdependencies.
This section focuses on:

Monthly dynamics of delay causes

Correlations between delay types

Fine-grained temporal patterns

Extreme delays and their propagation mechanisms
...
ggplot(late_ts, aes(x = fl_date, y = late_mean)) +
geom_line() +
labs(
...
ggplot(late_jan, aes(x = fl_date, y = late_mean)) +
geom_line(color = "black") +
geom_point(size = 2) +
labs(
title = "Daily Arrival Delays – January",
x = "Date",
y = "Average delay (minutes)"
) +
theme_minimal()
...
Internal causes represent a key lever for preventive action

External causes require reactive and adaptive strategies

## Conclusion
This temporal analysis demonstrates that flight delays are not random events but exhibit:

Strong temporal clustering

Clear propagation mechanisms

Distinct behaviors between internal and external causes

These insights are essential for robust delay mitigation strategies and pave the way
for predictive or causal modeling approaches.
